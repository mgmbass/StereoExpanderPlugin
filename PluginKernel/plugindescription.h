...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_CFD0FB348AD14349B4DDB91902912CD7
#define AU_COCOA_VIEW_NAME AUCocoaView_CFD0FB348AD14349B4DDB91902912CD7
...
const char* kAAXBundleID = "rackafxuser.aax.Pre-Project.bundleID";
const char* kVST3BundleID = "rackafxuser.vst3.Pre-Project.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "rackafxuser.au.Pre-Project.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "Pre-Project";     // 31 chars max for AAX
const char* kShortPluginName = "Pre-Project";    // 15 chars max for AAX
const char* kAUBundleName = "Pre-Project";
...
const char* kVSTFUID = "{CFD0FB34-8AD1-4349-B4DD-B91902912CD7}"; /// NOTE: you need the enclosing { }
